...
public class JC18011591Q09 extends JFrame {
	private MyLabel bar = new MyLabel(100); // 바의 최대 크기를 100으로 설정
	
	public JC18011591Q09(String title) {
		super(title);
		...
		Thread th =new Thread(new ConsumerThread(bar));// 스레드 생성
		th.start(); // 스레드 시작
	}

	public static void main(String[] args) {
		new JC18011591Q09("아무키나 빨리 눌러 바 채우기");
	}
}